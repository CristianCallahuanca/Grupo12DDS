...
public class ServicioFiltradorDeHechos {

    public static List<Hecho> filtrarHechos(List<Hecho> unosHechos, List<CriterioDePertenencia> filtros) {
        return unosHechos.stream().filter(unHecho -> filtrarHecho(unHecho,filtros))
                .toList();
    }

    private static boolean filtrarHecho(Hecho unHecho,List<CriterioDePertenencia> filtros) {
    ...
    private static boolean cumpleElTipoDeFiltro(Hecho unHecho, CriterioDePertenencia unFiltro, List<CriterioDePertenencia> filtros) {
    ...
    private static Boolean coincidenTipos(CriterioDePertenencia unFiltro, CriterioDePertenencia otroFiltro) {
